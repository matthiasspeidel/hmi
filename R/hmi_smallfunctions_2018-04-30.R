...
#' 2. to check whether a factor can epxlain at least three observed piles of observations in the data
...
#' (this means for equal lower bounds) by ther upperbounds. Both in increasing order.
...
#' Logarithm function
#'
#' Function take the (natural) logarithm of interval objects
#' @param interval an object from class interval
#' @return an interval object
#' @export
"log.interval" <- function(interval){
  tmp <- log(split_interval(interval))
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}

#' Exponential function
#'
#' Taking the exponential of interval objects
#' @param interval an object from class interval
#' @return an interval object
#' @export
"exp.interval" <- function(interval){
  tmp <- exp(split_interval(interval))
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}
...
#'
#' Taking the quare root of interval objects
#' @param interval an object from class interval
#' @return an interval object
#' @export
"sqrt.interval" <- function(interval){
  tmp <- sqrt(split_interval(interval))
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}

#' Rounding function
#'
#' Function to round interval objects
#' @param interval an object from class interval
#' @return an interval object
#' @export
"round.interval" <- function(interval, ...){
  tmp <- round(split_interval(interval), ...)
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}

#' Floor function
#'
#' Function to take the floor of interval objects
#' @param interval an object from class interval
#' @return an interval object
#' @export
"floor.interval" <- function(interval){
  tmp <- floor(split_interval(interval))
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}

#' Ceiling function
#'
#' Function to take the ceiling interval objects
#' @param interval an object from class interval
#' @return an interval object
#' @export
"ceiling.interval" <- function(interval){
  tmp <- ceiling(split_interval(interval))
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}
...
#' Head function
#'
#' Function to showing the head of an interval object
#' @param interval an object from class interval
#' @return an interval object
#' @export
"head.interval" <- function(interval, ...){
  tmp <- head(split_interval(interval), ...)
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}
...
#' Tail function
#'
#' Function to showing the tail of an interval object
#' @param interval an object from class interval
#' @return an interval object
#' @export
"tail.interval" <- function(interval, ...){
  tmp <- tail(split_interval(interval), ...)
  generate_interval(lower = tmp[, 1], upper = tmp[, 2])
}
...
#' cointaining the covariate names from the original rounding formula.
