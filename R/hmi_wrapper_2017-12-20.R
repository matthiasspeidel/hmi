...
#' @param additional_variables A character with names of variables (seperated by "+", like "x8+x9")
...
How do you want to proceed: \n
  ...
  model_formula_org <- model_formula
    ...
    model_formula <- as.formula(paste(format(model_formula), additional_variables, sep = "+"))
